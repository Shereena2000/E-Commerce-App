...
// class FilterAndSortButton extends StatelessWidget {
//   // final Function(Map<String, bool>, Map<String, bool>, Map<String, bool>) onFilterApplied;
...
//                         text: "Apply Filter",
//                         onPressed: () {
//                           // onFilterApplied(selectedSizes, selectedColor, selectedPriceRange);
//                           // print(selectedSizes);
//                           // print(selectedColor);
//                           // print(selectedPriceRange);
//                             print("Selected Sizes: ${filterStateProvider.selectedSize}");
//                             print("Selected Colors: ${filterStateProvider.selectedColor}");
//                             print("Selected Price Ranges: ${filterStateProvider.selectedPriceRange}");
//                           Navigator.pop(context);
//                         },
//                       ),
//                       largerSpacing,
