...
//   // Normalize keys to match what's used in FilterItem
//   String normalizedKey = key.toLowerCase().replaceAll(" ", ""); // Convert to lowercase and remove spaces

//   if (normalizedKey == 'size') {
//     if (value) {
//       if (!selectedSize.contains(item)) selectedSize.add(item);
//     } else {
//       selectedSize.remove(item);
//     }
//   } else if (normalizedKey == 'color') {
//     if (value) {
//       if (!selectedColor.contains(item)) selectedColor.add(item);
//     } else {
//       selectedColor.remove(item);
//     }
//   } else if (normalizedKey == 'prizerange') {
//     if (value) {
//       if (!selectedPriceRange.contains(item)) selectedPriceRange.add(item);
//     } else {
//       selectedPriceRange.remove(item);
//     }
//   }
